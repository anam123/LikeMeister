        ...
        protected void onPostExecute(String res) {
          ...
          //  LinkedHashMap<String,Integer> likes=new LinkedHashMap<>();
            ...
            else if(profile==false && image==false && video==false && lnk==true)
            {
                ...
                Double finale= (1.4*linklikes+1.6*((linklikechange+1)*(linklikes))+0.4*averagelikes+0.6*likesperword*(weight(status1).size())+increasepertaglink*tags+statuslikes)/6.0;
                answer=Math.ceil(finale);
